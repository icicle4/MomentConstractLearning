...
def eval_seq(opt, dataloader, data_type, result_filename, save_dir=None, show_image=True):
    ...
    results = []
    frame_count = 0
    for frame_id, (img0, frame_clips_and_bboxes) in enumerate(dataloader):
        if frame_id % 20 == 0:
        ...
        online_targets = tracker.update(frame_clips_and_bboxes)
    ...
    return frame_count, timer.average_time, timer.calls
...
if __name__ == '__main__':
    ...
    if not opt.val_mot16:
        seqs_str = '''KITTI-13
                      ...
                      TUD-Campus
                      TUD-Stadtmitte'''
        data_root = os.path.join(opt.data_dir, '2DMOT2015/images/train')
    else:
        seqs_str = '''MOT16-02
                      MOT16-04
                      MOT16-05
